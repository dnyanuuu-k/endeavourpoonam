...
function BlogPageExpand4() {
    // Filter the data based on the specified range of IDs (6 to 20)
  const filteredData3 = BlogCardData.filter(entry => entry.id >= 200 && entry.id <= 239);
  ...
  return (
    <div>
       <Container>
        ...
        </Row> <div style={{ display: 'flex', justifyContent: 'space-between' }}>
  <ul><a href="/blog3" >previous</a></ul>  
  <ul><a href="/blog5" >next</a></ul>
</div>
      </Container>
...
export default BlogPageExpand4
